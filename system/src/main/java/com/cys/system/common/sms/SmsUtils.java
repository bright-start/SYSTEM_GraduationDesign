...
public class SmsUtils {
    ...
    public static SendSmsResponse sendSms(String mobile,String signName,String shopName,String templateCode,String accessKeyId,String accessKeySecret) throws ClientException {
